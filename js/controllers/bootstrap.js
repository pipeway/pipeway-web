...
/* Controllers */
  ...
  app.controller('AccordionDemoCtrl', ['$scope','$cookieStore', function($scope, $cookieStore) {
  ...
  // app.controller('LogoutCtrl', ['$scope', '$cookieStore', '$window', function($scope, $cookieStore, $window) {
